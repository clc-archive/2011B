...
<a href="http://j.mp/CLC-facebook" title="CLC on Facebook!" class="sociallink" OnClick="_gaq.push(['_trackEvent', 'Links', 'Facebook', 'Sidebar']);">
    <span id="facebook">
        <img class="socialimage noshadow" src="/facebook-f.png" height="28" width="18" alt="facebook" title="facebook" id="facebook-button" />
    </span>
</a>
<a href="http://www.linkedin.com/company/2667837?trk=tyah" title="CLC on Linked In" class="sociallink" OnClick="_gaq.push(['_trackEvent', 'Links', 'LinkedIn', 'Sidebar']);">
	<span id="linkedin">
		<img class="socialimage noshadow" src="/images/logos/linked-in.png" height="18" width="23" alt="IN" id="linkedin-button" />
	</span>
</a>