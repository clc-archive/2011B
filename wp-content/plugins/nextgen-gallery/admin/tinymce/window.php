...
jQuery(document).ready(function(){
    jQuery("#gallerytag").nggAutocomplete( {
        type: 'gallery',domain: "<?php echo home_url('index.html', is_ssl() ? 'https' : 'http'); ?>"
    });
    jQuery("#albumtag").nggAutocomplete( {
        type: 'album',domain: "<?php echo home_url('index.html', is_ssl() ? 'https' : 'http'); ?>"
    });
    jQuery("#singlepictag").nggAutocomplete( {
        type: 'image',domain: "<?php echo home_url('index.html', is_ssl() ? 'https' : 'http'); ?>"
    });
});
</script>
