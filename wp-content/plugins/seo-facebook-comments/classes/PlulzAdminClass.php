...

{
...

    {
         ...
         * @TODO create arg to tell if the createMetabox should also create a form or not
         ...
         * @TODO create arg to tell the closeMetabox if it should close a form or not
